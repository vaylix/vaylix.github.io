...
export const releases: ReleaseEntry[] = [
  {
    version: 'v0.4.0',
    date: '2026-05-30',
    notesHref: 'https://github.com/vaylix/vaylix/releases/tag/v0.4.0',
    assets: [
      {
        label: 'Linux',
        target: 'Server',
        arch: 'x86_64',
        format: '.tar.gz',
        href: 'https://github.com/vaylix/vaylix/releases/download/v0.4.0/vaylix-server-v0.4.0-linux-x86_64.tar.gz',
        icon: 'linux',
      },
      {
        label: 'Linux',
        ...
        arch: 'aarch64',
        format: '.tar.gz',
        href: 'https://github.com/vaylix/vaylix/releases/download/v0.4.0/vaylix-server-v0.4.0-linux-aarch64.tar.gz',
        icon: 'linux',
      },
      {
        label: 'macOS',
        ...
        arch: 'Apple Silicon',
        format: '.tar.gz',
        href: 'https://github.com/vaylix/vaylix/releases/download/v0.4.0/vaylix-server-v0.4.0-macos-aarch64.tar.gz',
        icon: 'macos',
      },
      {
        label: 'Windows',
        ...
        arch: 'x86_64',
        format: '.zip',
        href: 'https://github.com/vaylix/vaylix/releases/download/v0.4.0/vaylix-server-v0.4.0-windows-x86_64.zip',
        icon: 'windows',
      },
      {
        label: 'Linux',
        ...
        arch: 'x86_64',
        format: '.tar.gz',
        href: 'https://github.com/vaylix/vaylix/releases/download/v0.4.0/vaylix-client-v0.4.0-linux-x86_64.tar.gz',
        icon: 'linux',
      },
      {
        label: 'Linux',
        ...
        arch: 'aarch64',
        format: '.tar.gz',
        href: 'https://github.com/vaylix/vaylix/releases/download/v0.4.0/vaylix-client-v0.4.0-linux-aarch64.tar.gz',
        icon: 'linux',
      },
      {
        label: 'macOS',
        ...
        arch: 'Apple Silicon',
        format: '.tar.gz',
        href: 'https://github.com/vaylix/vaylix/releases/download/v0.4.0/vaylix-client-v0.4.0-macos-aarch64.tar.gz',
        icon: 'macos',
      },
      {
        label: 'Windows',
        ...
        arch: 'x86_64',
        format: '.zip',
        href: 'https://github.com/vaylix/vaylix/releases/download/v0.4.0/vaylix-client-v0.4.0-windows-x86_64.zip',
        icon: 'windows',
      },
    ],
  },
