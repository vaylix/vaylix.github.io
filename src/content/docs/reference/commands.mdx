...
These are administrative controls for exceptional operational workflows. Normal `0.5.x` failover uses leader election; application writes should target the current leader.
