...
The transport itself remains protocol version `2`; the `0.3.0` `EXEC` payload change and the `0.5.0` HA command additions are contract extensions within VTP2, not a new protocol version.
